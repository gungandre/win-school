...
const BeforeFooter = ({ tlComplete }) => {
  ...
  return (
    <>
      <div
        className="w-full h-svh  relative  bg-white-ivory section z-[11] max-sm:hidden block"
        ref={elemenRef}
      >
        <div className="w-full h-svh bg-sunset-coral clip-mask justify-center flex flex-col gap-y-[119px] relative bottom-0 circle-before-footer ">
